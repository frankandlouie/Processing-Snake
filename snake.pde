...
public class snakeBody
{
  ...
  public snakeBody(color c, int i)
  {
    snakeColor = c;
    activeColor = c;
    snakeNum = i;
  ...
  public void drawUnit()
  {
    ...
    //fill((xpos + 25) * 0.36, (ypos + 255) * 0.36, 255);
    //fill(0, (xpos + 25) * 0.36, (ypos + 255) * 0.36);
    //fill(128, (xpos + 25) * 0.36, (ypos + 255) * 0.36);
    //fill(255, (xpos + 25) * 0.36, (ypos + 255) * 0.36);
    fill(activeColor);

    square(xpos, ypos, squareSize);
    //text(snakeNum, xpos, ypos + squareSize - squareSize / 5);
  }
}
